...
if(isset($_GET['andon_id']) && is_numeric($_GET['andon_id']))
{
    ...
    if($row['andon_attention'] == 0)
    {
        die("Must be solved first. <a href='index.php'>Go Back</a>");
    }
    elseif($row['andon_attention'] == 1 && $row['andon_solution'] == 1)
    {
        die("This issue is already solved. <a href='index.php'>Go Back</a>");
    }
}
else
{
...
<div class="col-md-12">
    ...
    <div class="card card-widget widget-user">
        ...
        <img style="height: 90px; width:100px;" class="img-circle elevation-2" src="views/assets/img/wrench.gif" alt="User Avatar">
        </div>
            ...
            <div class="row">
                    ...
                    <form style="width: 100%;" method="post">
                        ...
                        <div class="form-group col-lg-12">
                            <label for="inputName3" class="col-sm-12 col-form-label">Solution Report</label>
                            <div class="col-sm-12">
                            <textarea class="form-control" name="report" id="summernote" placeholder="Notes"><?php (isset($_POST['report'])) ? ($report =  $_POST['report']) : ($report = ""); echo $report; ?></textarea>
                            </div>
                        </div>
                        ...
                        if($row['use_pass'] == 1):
                        ?>
                        <input type="hidden" name="use_pass" value="<?php echo $row['use_pass']; ?>">

                        <div class="form-group col-lg-12">
                            <label for="inputName3" class="col-sm-12 col-form-label">Plant Password</label>
                            <div class="col-sm-12">
                                <input type="password" name="plant_password" id="" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-info" name="solution">Record Solution</button>
                                <?php if($row['andon_alert_main'] == 3 && $row['andon_alert_main'] == 4): ?>
                                <button type="submit" class="btn btn-danger" name="no_material">No Materials</button>
                                <?php endif; ?>
                            </div>
                        </div>
