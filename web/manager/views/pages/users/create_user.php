                ...
                <div class="tab-pane active" id="settings">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <div class="col-sm-12">
                                <input type="text" class="form-control" name="first_name" id="firstname" placeholder="Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <div class="col-sm-12">
                                <input type="text" class="form-control" name="last_name" id="lastname" placeholder="Name">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="col-sm-12">
                                <input type="text" class="form-control" name="user_email" id="email" placeholder="Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="col-sm-12">
                                <input type="text" id="phone" name="user_phone" class="form-control"data-inputmask="'mask': ['999-999-9999 [x99999]', '+099 99 99 9999[9]-9999']" data-mask>
                                </div>
                            </div>
                  ...
                  <div class=" tab-pane" id="activity">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="usertype" name="user_type" style="width: 100%;">
                        ...
                        <option value="s">Agente de Ventas</option>
