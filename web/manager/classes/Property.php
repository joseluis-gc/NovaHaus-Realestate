...
class Property
{
    ...
    private function editProperty()
    {
        ...
        {
            $this->errors[] = "Parametro invalido.";
        }
        elseif (empty($_POST['vor'])) 
        {
            $this->errors[] = "Seleccione venta, renta o traspaso";
        ...
        ) 
        {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $property_id    = $this->db_connection->real_escape_string(strip_tags($_GET['id'], ENT_QUOTES));
                $name           = $this->db_connection->real_escape_string(strip_tags($_POST['name'], ENT_QUOTES));
                $tipo           = $this->db_connection->real_escape_string(strip_tags($_POST['tipo'], ENT_QUOTES));
                $vor            = $this->db_connection->real_escape_string(strip_tags($_POST['vor'], ENT_QUOTES));
                $street         = $this->db_connection->real_escape_string(strip_tags($_POST['street'], ENT_QUOTES));
                ...
                //see if address is already taken
                $sql = "SELECT * FROM property WHERE street = '" . $street . "' AND number = '" . $number . "' AND section = '" . $section . "' AND city_id = '" . $city_id . "' AND id != '".$property_id."' ;";
                $query_address = $this->db_connection->query($sql);
                ...
                else 
                {
                    ...
                    if($uploadOk == 1)
                    {
                        ...
                        if($new == 1)
                        {
                            $sql = "UPDATE property  SET name = '" . $name . "', tipo='" . $tipo . "', 
                            vor='" . $vor . "', street='" . $street . "', number='" . $number . "', 
                            section='".$section."', country_id='" . $country_id . "', state_id='" . $state_id . "',  
                            city_id='" . $city_id . "', description='" . $description . "', 
                            recamaras= '" . $recamaras . "', bathrooms ='" . $bathrooms . "', terreno='" . $terreno . "',
                             construccion='" . $construccion . "', cocina='" . $cocina . "',  cochera='" . $cochera . "', patio='" . $patio . "',
                              alberca='" . $alberca . "', precio='" . $precio . "', precio_interno='" . $precio_interno . "', 
                              moneda='" . $moneda . "', imagen_principal='" . $target_file . "', date_created='".$date_created."'
                        ...
                        else
                        {
                            ...
                            recamaras= '" . $recamaras . "', bathrooms ='" . $bathrooms . "', terreno='" . $terreno . "',
                             construccion='" . $construccion . "', cocina='" . $cocina . "',  cochera='" . $cochera . "', patio='" . $patio . "',
                              alberca='" . $alberca . "', precio='" . $precio . "', precio_interno='" . $precio_interno . "', 
                              moneda='" . $moneda . "', date_created='".$date_created."'
                            WHERE id = $property_id ";
    ...
    private function deleteImage()
    {
        ...
        {
            $this->errors[] = "Parametro de propiedad invalido";
        }
        elseif (empty($_POST['image_id'])) 
        {
            $this->errors[] = "Parametro de imagen invalido";
        }    
        elseif (
        ...
        ) 
        {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $property_id    = $this->db_connection->real_escape_string(strip_tags($_POST['property_id'], ENT_QUOTES));
                $image_id       = $this->db_connection->real_escape_string(strip_tags($_POST['image_id'], ENT_QUOTES));
                
                   

            
                $sql = "DELETE FROM property_images WHERE property_id = $property_id AND image_id = $image_id ";
                $query_new_property_insert = $this->db_connection->query($sql);
                ...
                $this->messages[] = "La imagen ha sido eliminada." . $sql;
