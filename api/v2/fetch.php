...
if(isset($_POST['limit'], $_POST['start']))
{
    ...
    if(isset($_GET['search']) || isset($_GET['vor']))
    {
      if($_GET['search'] != ''){
      ...
      if($_GET['vor'] != ''){
        $vor = " AND vor = '{$_GET['vor']}' ";
      }
      else{
        $vor = '';
      }

     $query = "SELECT * FROM property WHERE 1 $search $vor ORDER BY id DESC LIMIT ".$_POST['start'].", ".$_POST['limit']."  ";
    }
    else
    {
      $query = "SELECT * FROM property ORDER BY id DESC LIMIT ".$_POST['start'].", ".$_POST['limit']."  ";
    }
