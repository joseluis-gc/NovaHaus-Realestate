...
if(isset($_GET['id']))
{
    ...
    ?>
        ...
        <div style='border-radius:0; width:100%;height:300px;background-image: url("https://smartlaboratory.tech/novahaus/web/manager/<?php echo $row['imagen_principal'] ?>"); background-size:cover; background-position:center center' class="card-image"></div>
        ...
        <div class="container">
            <section>
                ...
                <div class="col s12 m8 ">
                    ...
                    <div style="height: 80px; " class="col s3 m3 l3    ">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M13.2 7.07L10.25 11l2.25 3c.33.44.24 1.07-.2 1.4-.44.33-1.07.25-1.4-.2-1.05-1.4-2.31-3.07-3.1-4.14-.4-.53-1.2-.53-1.6 0l-4 5.33c-.49.67-.02 1.61.8 1.61h18c.82 0 1.29-.94.8-1.6l-7-9.33c-.4-.54-1.2-.54-1.6 0z"/></svg>                    
                         <br>
                        <?php echo $row['terreno'] . " m2" ?>
                    </div>

                    <div style="height: 80px;" class="col s3 m3 l3  center-align ">
                ...
                <div style="margin-top: 50px;" class="col l12 s12">
                        ...
                        $image_url = substr($row_image['image_url'],6);
                        ?>
                            <div style="margin-top: 20px;" class="col m4 s12">
                                <div style='border-radius:5px; height:200px; width:100%; background-image: url("https://smartlaboratory.tech/novahaus/web/manager/<?php echo $image_url ?>"); background-size:cover; background-position:center center'  class=" ">
...
<script>
    $(document).ready(function() {
        $("#myForm").on('submit', function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://smartlaboratory.tech/novahaus/api/v2/sendmail.php',
                dataType: "json",
                data: formData,
